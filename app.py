...
# Header with authors
# ------------------------------------------------------------------
img1_base64 = encode_image_to_base64("1.jpeg")
img2_base64 = encode_image_to_base64("2.jpeg")
    ...
    <div style="margin-top:60px;display:flex;justify-content:space-between;align-items:center;padding-bottom:30px;">
        ...
        <div style="display:flex;gap:30px;">
            <div style="text-align:center;">
                <img src="data:image/jpeg;base64,{img1_base64}"
            ...
            <div style="text-align:center;">
                <img src="data:image/jpeg;base64,{img2_base64}"
                     style="width:100px;height:100px;border-radius:50%;border:2px solid #ccc;" />
